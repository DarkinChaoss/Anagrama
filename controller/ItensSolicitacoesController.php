<?php
	class ItensSolicitacoesController {
		...
		public static function getItem($id,$reempresao = false){
			$item = new ItensSolicitacaoModel();
			return $item->selectItem($id,$reempresao);
		}
		...
		public static function getEquipamentDataExpurgo($date, $equipment){
			$itens = new ItensSolicitacaoModel();
			return $itens->getEquipamentDataExpurgo($date, $equipment);
		}

		public static function getEquipamentDataEsterilizacao($date, $equipment){
			$itens = new ItensSolicitacaoModel();
			return $itens->getEquipamentDataEsterilizacao($date, $equipment);
		}
		
		public static function responsavel_tecnico_esterilizacao($lote, $equipment, $date){
			$itens = new ItensSolicitacaoModel();
			return $itens->responsavel_tecnico_esterilizacao($lote, $equipment, $date);
		}

		public static function responsavel_tecnico_expurgo($lote, $equipment, $date){
			$itens = new ItensSolicitacaoModel();
			return $itens->responsavel_tecnico_expurgo($lote, $equipment, $date);
		}

		public static function getItensWhere($equipment_id, $lote, $date){
			$itens = new ItensSolicitacaoModel();
			return $itens->getItensWhere($equipment_id, $lote, $date);
		}
		
		public static function getItensWhereExpurgo($equipment_id, $lote, $date){
			$itens = new ItensSolicitacaoModel();
			return $itens->getItensWhereExpurgo($equipment_id, $lote, $date);
		}
		
		//define quem os níveis maiores entre pai e fihlos da memsa composicação 
		
		public static function getCountItensMax($id){
			$itens = new ItensSolicitacaoModel();
			return $itens->getCountmodel($id);
		}

		public static function getProdId($id){
			$itens = new ItensSolicitacaoModel();
			return $itens->getProdId($id);
		}

		public static function wasItemInMountConference($idpai){
			$itens = new ItensSolicitacaoModel();
			return $itens->wasItemInMountConference($idpai);
		}
		
		public static function getItensFilhos($idpai){
			$itens = new ItensSolicitacaoModel();
			return $itens->getItensFilhos($idpai);
		}

		public static function sonCanProgress($idfilho){
			$itens = new ItensSolicitacaoModel();
			return $itens->sonCanProgress($idfilho);
		}
