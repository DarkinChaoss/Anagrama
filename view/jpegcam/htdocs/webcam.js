...
window.webcam = {
	...
	swf_url: 'view/jpegcam/htdocs/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: 'view/jpegcam/htdocs/shutter.mp3', // URI to shutter.mp3 sound
	...
	set_hook: function(name, callback) {
		...
		if (typeof(this.hooks[name]) == 'undefined')
			return alert("Hook não suportado: " + name);
	...
	get_movie: function() {
		...
		if (!this.loaded) return alert("Erro: A imagem da webcam não foi carregada!");
		var movie = document.getElementById('webcam_movie');
		if (!movie) alert("Erro: Não foi possível localizar os elementos DOM necessários!");
		return movie;
	},
