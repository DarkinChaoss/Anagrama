	...
	<form>
		...
		<div class="btn-group" data-toggle="buttons-radio" style="margin-top:15px; display: flex; width:270px;">
				...
				<label for="pn" style="width:70%;">
					...
					<a class="btn btn-primary active hover-button" id="bt-pn">
		...
		<div class="row-fluid">
			<div class="span4">
				<label>QRCode:</label>
				<input type="text" class="input-large" name="filtro" autofocus>
			</div>
					...
					$html .= "
	                            ...
	                            <table class='tableLinhas'>
									...
									<tr>
										...
										<td>Validade: " . DefaultHelper::converte_data($pro->pro_validacaofabricacao) . "</td>
									</tr>
									<tr>
				  ...
				  $html .= "
	                            ...
	                            <table class='tableLinhas'>
									...
									<tr>
										...
										<td>Validade: " . DefaultHelper::converte_data($vcons->pro_validacaofabricacao) . "</td>
									</tr>
									<tr>
										<td colspan='2'>Grupo de material: " . $gma->gma_nome . "</td>
