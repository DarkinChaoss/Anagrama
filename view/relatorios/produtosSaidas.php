...
?>
	...
	<form>
		<div class="row-fluid">
			...
			<div class="span4">
				...
				<input type="text" name="data1" class="input-small data" maxlength="10" value="<?php echo $dataInicial ?>" autocomplete="off">
				&nbsp;até&nbsp;
				<input type="text" name="data2" class="input-small data" maxlength="10" value="<?php echo $dataFinal ?>"  autocomplete="off">
				<br>
			</div>
	...
	<div id="divPrint">
		...
		if($_REQUEST['gerar'] == 1){
			...
			$dataR1 = DefaultHelper::converte_data($_REQUEST['data1']);
			$dataR2 = DefaultHelper::converte_data($_REQUEST['data2']);

			$relatorio = new RelatorioSaidaMaterialModel( true );

			if( $json = $relatorio->get( $dataR1 , $dataR2 ) ){

				$categorias = json_encode( $json['categorias'] );
				$series = json_encode( $json['series'] );
				...
				<script type="text/javascript">
					...
					Highcharts.chart('container', {
					    ...
					    title: {
					        text: 'Quantidade de Produtos Movimentados por dia e Setor'
					    },
					    xAxis: {
					    ...
					    yAxis: {
					        min: 0,
					        title: {
					            text: 'Total de Produtos Movimentados'
					        },
					        stackLabels: {
					            enabled: true,
					            style: {
