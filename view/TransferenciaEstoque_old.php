<?php
	...
	if ( $_SERVER['REQUEST_METHOD'] == 'GET'){
		//error_log("get...");
		//verifica se há trsnferencias nao concluidas
		//verificar este procedimento pois se outro usuario abrir a mesma tela poderá apagar a transferencia de outro q esta em andamento...,
...
?>
	...
	<div id="telaInsereProdQtde" class="modal hide fade">
		...
		<div class="modal-body" style="width: 530px; height: 4050px;">
			<b>* Este produto contém quantidade, selecione a quantidade que <br> deseja transferir</b>
			<br>
