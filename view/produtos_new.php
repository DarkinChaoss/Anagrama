		...
		<div class="row-fluid">
			<div class="span6">
				...
				<section class="container flex">
					...
					<div class="item">
						<label class="checkbox">
							<input type="checkbox" name="itemcomposicao" class="checkprod" id="itemComposto" value="1"> <b>Item da composição</b>
						</label>
					</div>
					<div class="item">
						<label class="checkbox">
				...
				<label class="labelfatherProduct">Qrcode da composição: </label>
				...
				<div class="boxinfofather" style="border: 1px solid #004ECC; padding:10px; background:#fff;">
					<h4 style="border:none !important; color:#004ECC; margin-bottom:4px;">Informações da composição: </h4>
				...
				<section class="container flex">
					...
					<div class="item">
						<label>Quant máx de reprocessamento:</label>
