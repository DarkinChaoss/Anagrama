		  ...
		  <br><br>
			<div class="row-span">
			  <div class="span4-cs shortcut">
			  	...
			  	<br><br>
			  	<p class="title-shortchut">Expurgo</p>
			  	<br><br>
			  	<p class="sub-title">Entrada de material para esterilização.</p>
			  	<a href="solicitacoes" class="btn">Ir para Expurgo</a>
			  </div>
			  <div class="span4-cs shortcut">
			  	<i class="fas fas fa-boxes icons-access" style="font-size:30px !important; color:#828282 !important;"></i>
			  	<br><br>
			  	<p class="title-shortchut">Área Limpa</p>
			  	<br>
			  	<p class="sub-title">Conferência / Montagem.</p>
			  	<br>
				<form id="formBusca">
			  ...
			  <div class="span4-cs shortcut">
			  	...
			  	<br><br>
			  	<p class="sub-title">Gere a etiqueta com lote de esterilização.</p>
			  	<br>
			  ...
			  <div class="span4-cs shortcut">
			  	...
			  	<br><br>
			  	<p class="title-shortchut">Transferência de Arsenal</p>
			  	<br><br>
			  	<p class="sub-title">Transfira produtos entre arsenais.</p>
			  ...
			  <div class="span4-cs shortcut">
			  	...
			  	<br><br>
			  	<p class="title-shortchut">Arsenal - saída de materiais</p>
			  	<br><br>
			  	<p class="sub-title">Dispense os materiais para uso em paciente ou setor.</p>
			  	<br><br>
			  	<a href="saidaMateriais" class="btn">Ir até saída</a>
			  </div>
			  <div class="span4-cs shortcut">
			  	...
			  	<br>
			  	<p class="sub-title">Confira os materiais após o procedimento.</p>
			  	<br>
			  	<a href="ConferenciaMaterial" class="btn">Ir até Conferência</a>
			  </div>
			  <div class="span4-cs shortcut">
			  	...
			  	<br>
			  	<p class="sub-title">Obtenha o histórico de movimentação do produto.</p>
			  	<br>
				<form class="form-search pull-right" method="GET" action="produtosHistorico">
					<input type="hidden" name="chProduto" value="pn" placeholder="Qr code" class="input-medium search-query" autofocus>
			  ...
			  <div class="span4-cs shortcut">
			  	...
			  	<br><br>
			  	<p class="sub-title">Saiba onde estão seus materiais e o vencimento da esterilização.</p>
			  	<br><br>
